...
From the first pre-alpha renderer to a visual editor and a modular runtime, every release has brought a new part of Atlas into focus. The [Vela release page](/releases/vela1) looks back at that journey, with images from the earliest releases to today.
