...
export default async function News() {
    ...
    return (
        <PageShell>
            <div className={`${container} pb-28 max-[760px]:pb-16`}>
                <header className="mb-16 flex items-end justify-between gap-8 max-[760px]:flex-col max-[760px]:items-start">
                    <div>
                        <h1 className="page-title">The newsroom.</h1>
                        <p className="page-lede mt-7 max-w-xl">
                            New releases. Work in progress.
                            <br />
                            Stories from the world of Atlas.
                        </p>
                    </div>
                    <a
